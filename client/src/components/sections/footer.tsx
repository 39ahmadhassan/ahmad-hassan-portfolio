import { Linkedin, Github, Twitter, MessageSquare, Mail, MapPin } from "lucide-react";
    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold text-primary mb-4">Ahmad Hassan</h3>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">&copy; 2024 Ahmad Hassan. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
